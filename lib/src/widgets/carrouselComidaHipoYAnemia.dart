...
class ComidaHipoYAn extends StatelessWidget {
  final List<String> imgList = [
    'assets/img/comidaHipo_1.png',
    'assets/img/comidaHipo_2.png',
    'assets/img/comidaHipo_3.png',
    'assets/img/comidaAn_1.png',
    'assets/img/comidaAn_2.png',
    'assets/img/comidaAn_3.png'
  ];
    ...
    return InkWell(
      onTap: () {
        ...
        if(index == 0){
          ...
          Navigator.pushNamed(context, '/comidaAnemia-1');
        }
        else if(index == 4){
          Navigator.pushNamed(context, '/comidaAnemia-2');
        }
        else if(index == 5){
          Navigator.pushNamed(context, '/comidaAnemia-3');
        }
