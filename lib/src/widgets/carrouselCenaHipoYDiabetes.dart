...
class CenaHipoYDiab extends StatelessWidget {
    ...
    return InkWell(
      onTap: () {
        ...
        if(index == 0){
          ...
          Navigator.pushNamed(context, '/cenaDiabetes-1');
        }
        else if(index == 4){
          Navigator.pushNamed(context, '/cenaDiabetes-2');
        }
        else if(index == 5){
          Navigator.pushNamed(context, '/cenaDiabetes-3');
        }
