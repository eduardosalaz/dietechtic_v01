...
class ComidaHipoYDiab extends StatelessWidget {
  final List<String> imgList = [
    'assets/img/comidaHipo_1.png',
    'assets/img/comidaHipo_2.png',
    'assets/img/comidaHipo_3.png',
    'assets/img/comida_1.png',
    'assets/img/comidaDiab_2.png',
    'assets/img/comidaDiab_3.png'
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        ...
        if(index == 0){
          Navigator.pushNamed(context, '/comidaHipotiroidismo-1');
        }
        else if(index == 1){
          Navigator.pushNamed(context, '/comidaHipotiroidismo-2');
        }
        else if(index == 2){
          Navigator.pushNamed(context, '/comidaHipotiroidismo-3');
        }
        else if(index == 3){
          Navigator.pushNamed(context, '/comidaDiabetes-1');
        }
        else if(index == 4){
          Navigator.pushNamed(context, '/comidaDiabetes-2');
        }
        else if(index == 5){
          Navigator.pushNamed(context, '/comidaDiabetes-3');
        }
