...
import 'package:dietechtic_v01/src/widgets/carrouselDesayunoHipoYAnemia.dart';
...
class DesayunoHipoYAnemia extends StatefulWidget {
...
class _ComidasPageState extends State<DesayunoHipoYAnemia> {
    ...
    return Column(
      children: <Widget>[
        ...
        ToogleButtonList(
          ...
          onPressed: (int value){
            if('$value'=='1'){
              Navigator.of(context).pushReplacementNamed('/comidaHipoYAnemia'); 
            }
            else if('$value' == '2'){
              Navigator.of(context).pushReplacementNamed('/cenaHipoYAnemia'); 
            }
