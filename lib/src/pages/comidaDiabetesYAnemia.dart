...
import 'package:dietechtic_v01/src/widgets/carrouselComidaDiabetesYAnemia.dart';
...
class ComidaDiabetesYAnemia extends StatefulWidget {
  
@override
  _ComidasPageState createState() => _ComidasPageState();
}

class _ComidasPageState extends State<ComidaDiabetesYAnemia> {
  @override
    ...
    return Column(
      children: <Widget>[
        ...
        ToogleButtonList(
          ...
          onPressed: (value){
            if('$value'=='1'){
              Navigator.of(context).pushReplacementNamed('/desayunoDiabetesYAnemia'); 
            }
            else if('$value' == '2'){
