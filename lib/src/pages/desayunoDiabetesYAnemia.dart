...
import 'package:dietechtic_v01/src/widgets/carrouselDesayunoDiabetesYAnemia.dart';
...
class DesayunoDiabetesYAnemia extends StatefulWidget {
...
class _ComidasPageState extends State<DesayunoDiabetesYAnemia> {
    ...
    return Column(
      children: <Widget>[
        ...
        ToogleButtonList(
          ...
          onPressed: (int value){
            if('$value'=='1'){
              Navigator.of(context).pushReplacementNamed('/comidaDiabetesYAnemia'); 
            }
            else if('$value' == '2'){
              Navigator.of(context).pushReplacementNamed('/cenaDiabetesYAnemia'); 
            }
