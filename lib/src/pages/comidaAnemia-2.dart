...
class ComidaAnemia2 extends StatelessWidget {
                ...
                children: <Widget>[
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(image: AssetImage('assets/img/comidaAn_2.png'), fit: BoxFit.cover)
                    ),
                  ),
                            ...
                            children:[Row(
                                        children: <Widget>[
                                          ...
                                          Container(
                                            ...
                                            child: Text(
                                              'Jugo para la anemia con remolacha, zanahoria y naranjas.',
                                              maxLines: 2,
                                              style: TextStyle(
                                      ...
                                      Padding(
                                        ...
                                        child: Text('- 1 remolacha.'),
                                      ),
                                      
                                      Padding(
                                        padding:EdgeInsets.symmetric(horizontal: screenSize.width*0.1, vertical: screenSize.height*0.01),
                                        child: Text('- 1 zanahoria.'),
                                      ),

                                      Padding(
                                        padding:EdgeInsets.symmetric(horizontal: screenSize.width*0.1, vertical: screenSize.height*0.01),
                                        child: Text('- 6 naranjas.'),
                                      ),
                                      ...
                                      Padding(
                                        padding:EdgeInsets.symmetric(horizontal: screenSize.width*0.1, vertical: screenSize.height*0.01),
                                        child: Text('1.- Lavar, pelar y picar 6 naranjas y añadir la zanahoria y la remolacha. Jugo con una licuadora o batidora.'),
                                      ),

                                      Padding(
                                        padding:EdgeInsets.symmetric(horizontal: screenSize.width*0.1, vertical: screenSize.height*0.01),
                                        child: Text('2.- Ponga el jugo dentro del refrigerador para que se enfríe.'),
                                      ),
