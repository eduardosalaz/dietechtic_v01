...
import 'package:dietechtic_v01/src/widgets/carrouselComidaHipoYAnemia.dart';
...
class ComidaHipoYAnemia extends StatefulWidget {
...
class _ComidasPageState extends State<ComidaHipoYAnemia> {
    ...
    return Column(
      children: <Widget>[
        ...
        ToogleButtonList(
          ...
          onPressed: (int value){
            if('$value'=='1'){
              Navigator.of(context).pushReplacementNamed('/desayunoHipoYAnemia'); 
            }
            else if('$value' == '2'){
