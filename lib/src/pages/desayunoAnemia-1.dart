...
class DesayunoAnemia1 extends StatelessWidget {
                ...
                children: <Widget>[
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(image: AssetImage('assets/img/desayunoAn_1.png'), fit: BoxFit.cover)
                    ),
                  ),
                          ...
                          child: new ListView(
                            ...
                            children:[Row(
                                      ...
                                      Padding(
                                        ...
                                        child: Text('- 2 zanahorias grandes.'),
                                      ),
                                      
                                      Padding(
                                        padding:EdgeInsets.symmetric(horizontal: screenSize.width*0.1, vertical: screenSize.height*0.01),
                                        child: Text('- Semillas de sésamo.'),
                                      ),

                                      Padding(
                                        padding:EdgeInsets.symmetric(horizontal: screenSize.width*0.1, vertical: screenSize.height*0.01),
                                        child: Text('- 1/2 pepino.'),
                                      ),
                                      ...
                                      Padding(
                                        padding:EdgeInsets.symmetric(horizontal: screenSize.width*0.1, vertical: screenSize.height*0.01),
                                        child: Text('- 1 Pimiento verde dulce.'),
                                      ),

                                      Padding(
                                        padding:EdgeInsets.symmetric(horizontal: screenSize.width*0.1, vertical: screenSize.height*0.01),
                                        child: Text('- 1 taza de espinacas.'),
                                      ),

                                      Padding(
                                        padding:EdgeInsets.symmetric(horizontal: screenSize.width*0.1, vertical: screenSize.height*0.01),
                                        child: Text('- 3 tomates medianos.'),
                                      ),
                                      ...
                                      Padding(
                                        padding:EdgeInsets.symmetric(horizontal: screenSize.width*0.1, vertical: screenSize.height*0.01),
                                        child: Text('1.- Debes pelar y cortar todos los ingredientes y colocarlos en la licuadora.'),
                                      ),

                                      Padding(
                                        padding:EdgeInsets.symmetric(horizontal: screenSize.width*0.1, vertical: screenSize.height*0.01),
                                        child: Text('2.- Cuando obtengas una mezcla sin trozos estará listo.'),
                                      ),
