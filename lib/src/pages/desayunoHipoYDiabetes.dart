...
import 'package:dietechtic_v01/src/widgets/carrouselDesayunoHipoYDiab.dart';
...
class DesayunoHipoYDiabetes extends StatefulWidget {
...
class _ComidasPageState extends State<DesayunoHipoYDiabetes> {
    ...
    return Column(
      children: <Widget>[
        ...
        ToogleButtonList(
          ...
          onPressed: (int value){
            if('$value'=='1'){
              Navigator.of(context).pushReplacementNamed('/comidaHipoYDiabetes'); 
            }
            else if('$value' == '2'){
              Navigator.of(context).pushReplacementNamed('/cenaHipoYDiabetes'); 
            }
