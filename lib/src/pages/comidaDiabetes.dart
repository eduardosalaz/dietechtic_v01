...
import 'package:dietechtic_v01/src/widgets/carrouselComidaDiab.dart';
...
class ComidaDiabetes extends StatefulWidget {
  
@override
  _ComidasPageState createState() => _ComidasPageState();
}

class _ComidasPageState extends State<ComidaDiabetes> {
  @override
    ...
    return Column(
      children: <Widget>[
        ...
        ToogleButtonList(
          ...
          onPressed: (value){
            if('$value'=='1'){
              Navigator.of(context).pushReplacementNamed('/desayunoDiabetes'); 
            }
            else if('$value' == '2'){
