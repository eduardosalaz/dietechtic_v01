...
import 'package:dietechtic_v01/src/widgets/carrouselComidaHipoYDiab.dart';
...
class ComidaHipoYDiabetes extends StatefulWidget {
...
class _ComidasPageState extends State<ComidaHipoYDiabetes> {
    ...
    return Column(
      children: <Widget>[
        ...
        ToogleButtonList(
          ...
          onPressed: (int value){
            if('$value'=='1'){
              Navigator.of(context).pushReplacementNamed('/desayunoHipoYDiabetes'); 
            }
            else if('$value' == '2'){
